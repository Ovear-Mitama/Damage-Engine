...
/**
 * 1.19 兼容层:1.19 没有 {@code net.minecraft.client.gui.components.Tooltip}(1.19.4 才引入),
 * {@code AbstractWidget} 也没有 {@code setTooltip}。
 * <p>
 * 这里只保留业务代码用到的 {@code create(Component)} 与 {@code toCharSequence(Minecraft)},
 * 提示文本由各处的自绘控件自己保存,并在悬停时用
 * {@link GuiGraphics#renderTooltip(net.minecraft.client.gui.Font, List, int, int)} 画出来。
 */

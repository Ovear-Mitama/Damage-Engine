...
/**
 * 1.19 兼容层:1.19 没有 {@code net.minecraft.client.gui.GuiGraphics}(1.20 才引入)。
 * <p>
 * 内部持有 1.19 时代的 {@link PoseStack} 与 GUI 缓冲源,对外提供与 1.20 GuiGraphics
...
public final class GuiGraphics {
    ...
    /** 立即提交缓冲:1.20 的 flush 对应 1.19 的 endBatch。 */
    public void flush() {
    ...
    /** 1.20 的带 z 版本填充;1.19 无等价物,用平移模拟深度偏移。 */
    ...
    /** 1.19 的 GuiComponent.blit 要求调用方自己设置着色器与贴图。 */
    ...
    /** 1.19 的裁剪要按 GUI 缩放换算成屏幕像素,并把 Y 轴翻转到 GL 的左下原点。 */

...
public class ColorPickerScreen extends Screen {
    ...
    private void playClickSound() {
        if (this.minecraft != null && this.minecraft.getSoundManager() != null) {
            this.minecraft.getSoundManager().play(
                net.minecraft.client.resources.sounds.SimpleSoundInstance.forUI(net.minecraft.sounds.SoundEvents.UI_BUTTON_CLICK.value(), 1.0F)
            );
        }
    }
    ...
    private void ensureSquareTexture() {
        ...
        if (squareTexture == null) {
            ...
            squareTexId = ResourceLocation.fromNamespaceAndPath("damage-engine", "color_square_" + System.nanoTime());
        ...
        if (Math.abs(hue - squareHueCache) > 0.0005f) {
            ...
            for (int y = 0; y < 256; y++) {
                ...
                for (int x = 0; x < 256; x++) {
                    ...
                    // 1.21.1 setPixelRGBA 按 ABGR 字节序存储,需交换 R/B

 ...
 *
 * <p>Driven by {@code LivingEntityClientMixin} on both loaders, with per-entity
 * state kept in a static map so the same logic stays usable outside the mixin if
 * needed.</p>
 */

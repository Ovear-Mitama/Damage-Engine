...
public class DamageHud {
     ...
     */
    public void beginGlobalShift(GuiGraphics guiGraphics) {
    ...
    public void endGlobalShift(GuiGraphics guiGraphics) {
     ...
     */
    public void suspendGlobalShift(GuiGraphics guiGraphics) {
        if (!globalShiftActive) return;
        guiGraphics.pose().translate(-globalShiftX, -globalShiftY, 0);
    }

    public void resumeGlobalShift(GuiGraphics guiGraphics) {
        if (!globalShiftActive) return;
        guiGraphics.pose().translate(globalShiftX, globalShiftY, 0);
    }
    ...
    public void renderHistory(GuiGraphics guiGraphics, List<DamageSessionManager.DamageEntry> history, boolean isPreview, float globalAlpha, Minecraft client) {
        ...
        for (int i = renderList.size() - 1; i >= 0; i--) {
            ...
            if (!isPreview && recordOtherPlayers && entry.attackerId() > 0 && client.level != null) {
                ...
                if (attackerEntity instanceof AbstractClientPlayer attackerPlayer) {
                    ...
                    if (skin != null) {
                        ...
                        drawPlayerFace(guiGraphics, skin.texture(), avatarX, (int)yPos, 8, true);
                        guiGraphics.setColor(1.0f, 1.0f, 1.0f, 1.0f);
                    }
                }
            }
            ...
            if (avatarGap > 0 && previewSkin != null) {
                ...
                drawPlayerFace(guiGraphics, previewSkin.texture(), previewAvatarX, (int)yPos, 8, true);
                guiGraphics.setColor(1.0f, 1.0f, 1.0f, 1.0f);
            }
     ...
     */
    private static void drawBarRange(GuiGraphics guiGraphics, int barX, int barY, int barW, int barH,
